...
public class MachineServiceTest {
    ...
    public void setUp() {
        ...
        // Persister la salles avant d'utiliser
        ...
        // CCréer et persister la machine avant chaque test
    ...
    public void testFindBetweenDate() {
        ...
        assertNotNull("Machine list should not be null", machines);
        assertTrue("Machine list should contain at least one machine", machines.size() > 0);
    }
}
